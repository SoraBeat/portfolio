...
const Contactme = () => {
  ...
  return (
    <AnimatedDiv>
      <div className="flex flex-col max-w-[1200px] lg:flex-row justify-center items-center w-11/12 md:w-8/12 lg:w-9/12 mx-auto overflow-hidden gap-5 xl:gap-20 -mt-5 lg:mt-5">
